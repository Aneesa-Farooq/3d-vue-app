  ...
  mounted() {
    ...
    axios
      ...
      .then((response) => {
        ...
        const INITIAL_MAP = [{ childID: "Object_2", mtl: INITIAL_MTL }];
        ...
        gltfLoader.load("/assets/pakBlouse/scene.gltf", function (gltf) {
          theModel = gltf.scene;
          theModel.position.y = -40;
          theModel.position.x = 40;
        ...
        function selectSwatch(e) {
          ...
          setMaterial(theModel, "Object_2", new_mtl);
        }
